            ...
            <Row className="d-flex justify-content-center align-items-center">
              <Board lg="9">
                ...
                <ProfileCard className="row">
                  <div className="col padding-dynamic">
                    <p>
                    <a href="https://github.com/Srinivassista/portfolio-srinivas/blob/main/src/assets/cert/Data_Analyst.pdf" download>• Data Analyst Professional Certificate | IBM (Coursera)</a>
                    </p>
                    <p>
                    <a href="https://github.com/Srinivassista/portfolio-srinivas/blob/main/src/assets/cert/SQL_basics.pdf" download>• SQL Basics for Data Science | UC Davis (Coursera)</a>
                    </p>
                    <p>
                    <a href="https://github.com/Srinivassista/portfolio-srinivas/blob/main/src/assets/cert/tableau.pdf" download>• Data Vizualisation with Tableau | UC Davis (Coursera)</a>
                    </p>
